    ...
    <div className="mt-40 text-gray-900 min-h-screen">
      ...
      <header className="bg-purple-100 text-gray-800 py-12 text-center">
        ...
        <p className="text-lg text-gray-600">
          Learn how Insurifiy handles copyright infringement claims under the DMCA.
        </p>
      </header>
      ...
      <main className="max-w-4xl mx-auto px-6 py-16 space-y-12">
        ...
        <section className="bg-white p-8 rounded-lg shadow-md">
          ...
          <p className="text-lg text-gray-700 mb-4">
            The Digital Millennium Copyright Act (DMCA) is a U.S. law that protects the rights of copyright holders by enabling them to report infringing content. Insurifiy complies fully with the DMCA and respects the intellectual property of others.
          </p>
        ...
        <section className="bg-white p-8 rounded-lg shadow-md">
          ...
          <p className="text-lg text-gray-700 mb-4">
            If you believe that content on Insurifiy infringes on your copyright, please send a written DMCA notice to our designated agent including the following:
          </p>
        ...
        <section className="bg-white p-8 rounded-lg shadow-md">
          ...
          <p className="text-lg text-gray-700">
            Insurifiy has a zero-tolerance policy for repeat copyright infringers. We may terminate user accounts or access for repeat offenders at our sole discretion.
          </p>
        </section>
        ...
        <section className="bg-white p-8 rounded-lg shadow-md">
          ...
          <p className="text-lg text-gray-700">
            <strong>Email:</strong> legal@Insurifiy.com
            <br />
            <strong>Address:</strong> Insurifiy, Attn: DMCA Agent, 1234 Street Name, City, State, 12345
          </p>
        </section>
