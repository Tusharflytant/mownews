    ...
    <div className="mt-40 text-gray-900 min-h-screen">
      ...
      <header className="bg-purple-100 text-gray-800 py-12 text-center">
        ...
        <p className="text-lg text-gray-600">
          Learn how Insurifiy uses cookies and similar technologies to enhance your browsing experience.
        </p>
      </header>
      ...
      <main className="max-w-4xl mx-auto px-6 py-16 space-y-12">
        ...
        <section className="bg-white p-8 rounded-lg shadow-md">
          ...
          <p className="text-lg text-gray-700 mb-4">
            Cookies are small data files stored on your device when you visit websites. They help improve functionality, analyze usage, and deliver personalized content. Insurifiy uses cookies to enhance performance and tailor your experience.
          </p>
        ...
        <section className="bg-white p-8 rounded-lg shadow-md">
          ...
          <p className="text-lg text-gray-700">
            Insurifiy may update this Cookies Policy from time to time. We encourage you to review this page periodically for any changes. Your continued use of our site signifies your agreement to the updated terms.
          </p>
        </section>
      </main>
    </div>
